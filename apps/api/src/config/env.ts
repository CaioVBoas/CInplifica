...
export const env = {
  ...
  cinSsoClientId: getEnv('CIN_SSO_CLIENT_ID'),
  cinSsoClientSecret: getEnv('CIN_SSO_CLIENT_SECRET'),
  cinSsoIssuer: getEnv('CIN_SSO_ISSUER'),
  cinSsoAuthorizationUrl: getEnv('CIN_SSO_AUTHORIZATION_URL'),
  cinSsoTokenUrl: getEnv('CIN_SSO_TOKEN_URL'),
  cinSsoUserInfoUrl: getEnv('CIN_SSO_USERINFO_URL'),
  cinSsoCallbackUrl: getEnv('CIN_SSO_CALLBACK_URL'),
